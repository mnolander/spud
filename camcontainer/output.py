...
class DetectorThread(threading.Thread):
    ...
    def __init__(self, detection_queue: queue.Queue, detection_result_queue: queue.Queue):
        ...
        self.camera_intrinsics = {
            "DEV_1AB22C00E123": [7546.504282257504, 7572.10146981953, 2545.2539699317235, 1314.455048064746],
            "DEV_1AB22C00E588": [7524.609921045258, 7569.595628446317, 1832.0928936549217, 1296.8212355141798]
        }

        # Physical size of the AprilTag (in meters)
        self.tag_size = 0.162  # Example: 16.2 cm
